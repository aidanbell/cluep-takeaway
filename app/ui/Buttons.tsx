...
export function NavItem({ icon, text, active, key, navOpen }: { icon: string, text: string, active: boolean, key: number, navOpen: boolean }) {
  return (
    <div
      className={`nav-item transform -translate-x-full transform transition-all duration-500 ease-out delay-500 flex flex-row items-center m-1 pr-2 hover:rounded-lg hover:bg-gray-800 ${
